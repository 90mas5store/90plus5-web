...
// Reiniciar el módulo entre tests para limpiar el Map interno
beforeEach(() => {
    vi.resetModules();
});
...
describe("checkRateLimit", () => {
    ...
    it("acumula solicitudes dentro de la ventana", () => {
        const key = "test-ip-2";
    ...
    it("resetea la ventana después del tiempo definido", async () => {
        ...
        checkRateLimit(key, 1, 10); // ventana de 10ms
        checkRateLimit(key, 1, 10); // bloquear
