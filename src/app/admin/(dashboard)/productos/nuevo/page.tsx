...
export default function CreateProductPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // 2.1 Insert Product Leagues (Multi-League & Single League Sync)
                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 sm:gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-lg sm:text-2xl font-black text-white tracking-tight truncate">Nuevo Producto</h1>
                            <p className="text-gray-400 text-[10px] sm:text-xs font-mono opacity-60 truncate">Crear un nuevo ítem en el catálogo</p>
                        </div>
                    </div>
                    <button
                        type="button"
