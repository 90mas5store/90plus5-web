...
import { LayoutDashboard, Package, LogOut, Menu, X, Shirt, Users, Settings, FileSpreadsheet, Tag, Trophy, Shield, LayoutTemplate, Trash2, Lock, Activity } from 'lucide-react';
